  ...
  personalTimeline: [
    {
      ...
      description:
        'Contributing to a diverse range of Typescript, Javascript and Kotlin applications. Focusing on React, Node.js and Android development.',
      dateRange: 'Mar 2022 - 🔮',
    },
    {
      title: 'Android Engineer | @FluentStream',
      description:
        'Transitioned into an Android Engineer, and learned a lot. Maintained a Saas mobile application. Worked on duplicating functionality of a React Native app into an Android one.',
      dateRange: 'Jan 2021 - Feb 2022',
    },
    {
      title: 'Software Engineer | @FluentStream',
      description:
        'Contributed to all company products across the stack. Designed endpoints to fetch data for new components. Developed new features to satisfy client requirements. Communicated development needs to the business.',
      dateRange: 'May 2019 - Jan 2021',
    },
    {
      title: 'Intro To JavaScript Course Lead | @Galvanize',
      description:
        'Taught a free introduction to JavaScript and the web course. Started from the basics on how the sequence is read, and what keywords do. And if time allotted, we would transition into how we can use JavaScript to manipulate the DOM.',
      dateRange: 'Sept 2018 - Jan 2019',
    },
    {
      title: 'Student | @Galvanize',
      description:
        'Six month, full-time web development immersive program. Creating applications for numerous work environments. Learning to build production-worthy applications with front-end and back-end proficiency.',
